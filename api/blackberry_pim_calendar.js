 ...
 * @learns {Sample - Using Calendar API to add, search and remove events} https://github.com/blackberry/BB10-WebWorks-Samples/tree/master/pimcalendar Sample that demonstrates how to use the BlackBerry Calendar API [BlackBerry on GitHub].
